...
export class EmailTemplateDto {
  ...
  @ApiProperty({
    description:
      "Subject line for the email (can use placeholders like {{username}})",
  ...
  @ApiProperty({
    description:
      "HTML body content for the email (can use placeholders like {{link}})",
    example:
      '<p>Hello {{username}}, click <a href="{{link}}">here</a> to reset your password.</p>',
  })
  @IsString()
  @IsNotEmpty()
  bodyHtml: string;
