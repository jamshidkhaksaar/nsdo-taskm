...
export class UpdateApiSettingsDto {
  ...
  @ApiProperty({ description: 'API key for external integrations', required: false })
  @IsOptional()
  @IsString()
  api_key?: string;

  @ApiProperty({ description: 'Enable WeatherAPI.com integration', required: false })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiProperty({ description: 'Comma-separated list of allowed IP addresses', required: false })
  @IsOptional()
  @IsString()
