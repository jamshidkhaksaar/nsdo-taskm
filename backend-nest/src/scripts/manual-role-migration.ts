...
async function manualRoleMigration() {
  ...
  try {
    ...
    console.log(`Updated manager roles: ${managerResult.affectedRows || 0} rows affected`);
    ...
    console.log(`Updated general_manager roles: ${gmResult.affectedRows || 0} rows affected`);
    ...
    await connection.query(`ALTER TABLE \`user\` MODIFY COLUMN \`role\` VARCHAR(255) NOT NULL`);
