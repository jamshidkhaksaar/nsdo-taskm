...
if (!fs.existsSync(envPath)) {
  ...
  console.error('Create a .env file with database credentials before running migrations.');
...
const requiredVars = ['DATABASE_HOST', 'DATABASE_PORT', 'DATABASE_USERNAME', 'DATABASE_PASSWORD', 'DATABASE_NAME'];
...
if (missingVars.length > 0) {
  ...
  console.log('Environment check: All required database variables are present.');
