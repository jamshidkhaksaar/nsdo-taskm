...
export class DepartmentsController {
  ...
  async getTasksForDepartment(@Param("id", ParseUUIDPipe) id: string, @Request() req) {
    ...
    // Check permissions: admin and leadership can view any department's tasks
    ...
    if (userRole === 'user') {
      ...
      if (!userDepartmentIds.includes(id)) {
        throw new ForbiddenException('You can only view tasks for departments you belong to');
      }
    }
